 ...
 * allocated
 */
void initial_hash_local(uint8_t *blockhash, argon2_context *context, argon2_type type);
 ...
 */
void fill_segment_local(const argon2_instance_t *instance, argon2_position_t position);
