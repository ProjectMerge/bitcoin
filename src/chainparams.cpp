...
public:
    CMainParams() {
        ...
        consensus.BIP34Height = std::numeric_limits<uint32_t>::max();
        consensus.BIP34Hash = uint256();
        consensus.BIP65Height = std::numeric_limits<uint32_t>::max();
        consensus.BIP66Height = std::numeric_limits<uint32_t>::max();
